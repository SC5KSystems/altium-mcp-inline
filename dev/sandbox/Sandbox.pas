...
begin
    ...
    try
        ...
        // A pin with THRU > 0, or with ENDS = 0 while wires are nearby, is suspect.
        // Junctions are listed with how many wire ends meet them: a junction with
        // fewer than 3 is decoration, and usually marks an overshoot.
